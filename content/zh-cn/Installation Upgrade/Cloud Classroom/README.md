...
远程桌面服务  
![](./images/eclass_2_19.png)  
Hyper-V 管理器快捷方式  
![](./images/eclass_2_20.png)  
Windows更新的配置，建议安装一下Windows的补丁。  
![](./images/eclass_2_21.png)  
关闭管理员的IE增强安全特性  
![](./images/eclass_2_22.png)  
...
![](./images/eclass_9_1.png) 

                                                        （9-3）
2. 进入弹窗，点击“确定”按钮。完成还原。如图（9-4）所示。
![](./images/class_10_9.png) 
